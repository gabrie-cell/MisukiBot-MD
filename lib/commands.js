export const bodyMenu = `> 𖧧 ¡Hola! *@$sender*, 𝐒𝐎𝐘 *$namebot*, 𝐀𝐪𝐮𝐢́ 𝐭𝐢𝐞𝐧𝐞𝐬 𝐥𝐚 𝐥𝐢𝐬𝐭𝐚 𝐝𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨𝐬$cat
...
> 𝚅𝙸𝙽𝙲𝚄𝙻𝙰 𝚃𝚄 *Socket* con tu número utilizando *$prefixqr* o *$prefixcode*.
‧꒷︶꒷꒥꒷‧₊˚꒷︶꒷꒥꒷︶꒷˚₊‧꒷꒥꒷︶꒷‧`
export const menuObject = {
economia: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙀𝘾𝙊𝙉𝙊𝙈𝙄𝘼 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
gacha: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙂𝘼𝘾𝙃𝘼 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
downloads: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙎 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
profile: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙋𝙍𝙊𝙁𝙄𝙇𝙀𝙎?╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
sockets: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙎𝙊𝘾𝙆𝙀𝙏 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
utils: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙐𝙏𝙄𝙇𝙄𝙎 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
grupo: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙂𝙍𝙐𝙋𝙊𝙎 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
nsfw: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝙋𝙊𝙍𝙉𝙄𝙏𝙊 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
...
> Chupar tetas.
╰ׅ͜─֟͜─͜─ٞ͜─͜─๊͜─͜─๋͜─⃔═̶፝֟͜═̶⃔─๋͜─͜─͜─๊͜─ٞ͜─͜─֟͜┈ࠢ͜╯ׅ`,
anime: `╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 𝘼𝙉𝙄𝙈𝙀 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
