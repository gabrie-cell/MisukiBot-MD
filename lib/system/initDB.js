...
function initDB(m, client) {
  ...
  settings.nameid ??= "'ೃ࿔ ꩇׁׅ֪݊ ꪱׁׁׁׅׅׅׅ꯱υׁׅƙׁׅꪱׁׁׁׅׅׅ'ร - σƒƒเ૮เαℓ ૮ɦαɳɳεℓ .ೃ࿐"
  settings.type ??= 'Owner'
  settings.link ??= 'https://whatsapp.com/channel/0029VbCJFHmFy72CvfvzSR0Q'
  settings.banner ??= 'https://files.catbox.moe/6stsz2.jpeg'
  settings.icon ??= 'https://files.catbox.moe/mch14u.jpeg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'Misuki'
  settings.botname ??= 'Misuki'  
  settings.owner ??= 'gabxz'
